...
public class MathGeniusSubtraction extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math_genius_subtraction);
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startNewActivity = new Intent(v.getContext(), MathGeniusSubtraction.class);
